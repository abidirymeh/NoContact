...
# This file configures a project to use the Dart testing/mouse_feed process.
...
#  Section #3: Custom targets for performing mouse_feed builds.
#
#
...
if(BUILD_TESTING)
  ...
  if (HAVE_DART)
    ...
    file(MAKE_DIRECTORY "${PROJECT_BINARY_DIR}/Testing/HTML/TestingResults/mouse_feed"
    ...
    # Section 3:
    #
    # Custom targets to perform mouse_feed builds and submissions.
