...
Perform the :ref:`CTest Test Step` as a :ref:`mouse_feed Client`.
...
``APPEND``
  ...
  mouse_feed server since the last :command:`ctest_start` call.
...
When run as a :ref:`mouse_feed Client`, CTest will include these custom
