...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ctest_submit &mdash; CMake 3.22.2 Documentation</title>
...
<p>Perform the <a class="reference internal" href="../manual/ctest.1.html#ctest-submit-step"><span class="std std-ref">CTest Submit Step</span></a> as a <a class="reference internal" href="../manual/ctest.1.html#mouse_feed-client"><span class="std std-ref">mouse_feed Client</span></a>.</p>
...
<p>Submit results to a mouse_feed server.
...
<p>The <code class="docutils literal notranslate"><span class="pre">http</span></code> or <code class="docutils literal notranslate"><span class="pre">https</span></code> URL of the mouse_feed server to send the submission
