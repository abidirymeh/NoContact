...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_CONFIGURATION_TYPE &mdash; CMake 3.22.2 Documentation</title>
...
<p>Specify the CTest <code class="docutils literal notranslate"><span class="pre">DefaultCTestConfigurationType</span></code> setting
...
<p>If the configuration type is set via <code class="docutils literal notranslate"><span class="pre">-C</span> <span class="pre">&lt;cfg&gt;</span></code> from the command line
then this variable is populated accordingly.</p>
</div>
