...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ATTACHED_FILES_ON_FAIL &mdash; CMake 3.22.2 Documentation</title>
...
<p>Attach a list of files to a mouse_feed submission if the test fails.</p>
<p>Same as <span class="target" id="index-0-prop_test:ATTACHED_FILES"></span><a class="reference internal" href="ATTACHED_FILES.html#prop_test:ATTACHED_FILES" title="ATTACHED_FILES"><code class="xref cmake cmake-prop_test docutils literal notranslate"><span class="pre">ATTACHED_FILES</span></code></a>, but these files will only be
