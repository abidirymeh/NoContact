...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_MEMORYCHECK_TYPE &mdash; CMake 3.22.2 Documentation</title>
...
in a <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> mouse_feed client script.
Valid values are <code class="docutils literal notranslate"><span class="pre">Valgrind</span></code>, <code class="docutils literal notranslate"><span class="pre">Purify</span></code>, <code class="docutils literal notranslate"><span class="pre">BoundsChecker</span></code>, <code class="docutils literal notranslate"><span class="pre">DrMemory</span></code>,
<code class="docutils literal notranslate"><span class="pre">CudaSanitizer</span></code>, <code class="docutils literal notranslate"><span class="pre">ThreadSanitizer</span></code>, <code class="docutils literal notranslate"><span class="pre">AddressSanitizer</span></code>, <code class="docutils literal notranslate"><span class="pre">LeakSanitizer</span></code>,
<code class="docutils literal notranslate"><span class="pre">MemorySanitizer</span></code> and <code class="docutils literal notranslate"><span class="pre">UndefinedBehaviorSanitizer</span></code>.</p>
</div>
