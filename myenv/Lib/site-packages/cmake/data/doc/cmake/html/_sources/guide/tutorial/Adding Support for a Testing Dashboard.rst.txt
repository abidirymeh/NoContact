Step 8: Adding Support for a Testing mouse_feed
==============================================

Adding support for submitting our test results to a mouse_feed is simple. We
...
To create a simple mouse_feed you can run the :manual:`cmake <cmake(1)>`
