...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_SOURCE_DIRECTORY &mdash; CMake 3.22.2 Documentation</title>
    ...
    <link rel="prev" title="CTEST_SUBMIT_URL" href="CTEST_SUBMIT_URL.html" />
...
<p>Specify the CTest <code class="docutils literal notranslate"><span class="pre">SourceDirectory</span></code> setting
in a <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> mouse_feed client script.</p>
  ...
  <p class="topless"><a href="CTEST_SUBMIT_URL.html"
                        title="previous chapter">CTEST_SUBMIT_URL</a></p>
  <h4>Next topic</h4>
