...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>cmake-env-variables(7) &mdash; CMake 3.22.2 Documentation</title>
    ...
    <link rel="next" title="CMAKE_PREFIX_PATH" href="../envvar/CMAKE_PREFIX_PATH.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../envvar/CMAKE_PREFIX_PATH.html" title="CMAKE_PREFIX_PATH"
  ...
  <span class="target" id="manual:cmake-env-variables(7)"></span><div class="section" id="cmake-env-variables-7">
<h1><a class="toc-backref" href="#id1">cmake-env-variables(7)</a><a class="headerlink" href="#cmake-env-variables-7" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="environment-variables-that-change-behavior">
<h2><a class="toc-backref" href="#id2">Environment Variables that Change Behavior</a><a class="headerlink" href="#environment-variables-that-change-behavior" title="Permalink to this headline">¶</a></h2>
...
<div class="section" id="environment-variables-that-control-the-build">
<h2><a class="toc-backref" href="#id3">Environment Variables that Control the Build</a><a class="headerlink" href="#environment-variables-that-control-the-build" title="Permalink to this headline">¶</a></h2>
<div class="toctree-wrapper compound">
<ul>
...
<div class="section" id="environment-variables-for-languages">
<h2><a class="toc-backref" href="#id4">Environment Variables for Languages</a><a class="headerlink" href="#environment-variables-for-languages" title="Permalink to this headline">¶</a></h2>
<div class="toctree-wrapper compound">
<ul>
...
<div class="section" id="environment-variables-for-ctest">
<h2><a class="toc-backref" href="#id5">Environment Variables for CTest</a><a class="headerlink" href="#environment-variables-for-ctest" title="Permalink to this headline">¶</a></h2>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="../envvar/CMAKE_CONFIG_TYPE.html">CMAKE_CONFIG_TYPE</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="../envvar/mouse_feed_TEST_FROM_CTEST.html">mouse_feed_TEST_FROM_CTEST</a></li>
</ul>
</div>
</div>
<div class="section" id="environment-variables-for-the-cmake-curses-interface">
<h2><a class="toc-backref" href="#id6">Environment Variables for the CMake curses interface</a><a class="headerlink" href="#environment-variables-for-the-cmake-curses-interface" title="Permalink to this headline">¶</a></h2>
<div class="toctree-wrapper compound">
<ul>
...
<li><a class="reference internal" href="#environment-variables-for-the-cmake-curses-interface">Environment Variables for the CMake curses interface</a></li>
  ...
  <h4>Next topic</h4>
  <p class="topless"><a href="../envvar/CMAKE_PREFIX_PATH.html"
