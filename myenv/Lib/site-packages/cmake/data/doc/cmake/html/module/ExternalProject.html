...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ExternalProject &mdash; CMake 3.22.2 Documentation</title>
...
<span id="module:ExternalProject"></span><h1><a class="toc-backref" href="#id1">ExternalProject</a><a class="headerlink" href="#externalproject" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="external-project-definition">
<h3><a class="toc-backref" href="#id3">External Project Definition</a><a class="headerlink" href="#external-project-definition" title="Permalink to this headline">¶</a></h3>
<dl class="command">
<dt id="command:externalproject_add">
<code class="sig-name descname">ExternalProject_Add</code><a class="headerlink" href="#command:externalproject_add" title="Permalink to this definition">¶</a></dt>
...
If this option is not specified, the value of the <span class="target" id="index-0-variable:CMAKE_NETRC"></span><a class="reference internal" href="../variable/CMAKE_NETRC.html#variable:CMAKE_NETRC" title="CMAKE_NETRC"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_NETRC</span></code></a>
variable will be used instead (see <span class="target" id="index-4-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(DOWNLOAD)</span></code></a>)
Valid levels are:</p>
<dl class="simple">
...
<code class="docutils literal notranslate"><span class="pre">CMAKE_EP_GIT_REMOTE_UPDATE_STRATEGY</span></code> (see below).</p>
</dd>
...
changes or failed builds resulting from conflicts during rebase operations.</p>
</dd>
</dl>
</dd>
...
<dt><strong>Update/Patch Step Options:</strong></dt><dd><p>Whenever CMake is re-run, by default the external project's sources will be
...
<dt><code class="docutils literal notranslate"><span class="pre">CMAKE_ARGS</span> <span class="pre">&lt;arg&gt;...</span></code></dt><dd><p>The specified arguments are passed to the <code class="docutils literal notranslate"><span class="pre">cmake</span></code> command line. They
can be any argument the <code class="docutils literal notranslate"><span class="pre">cmake</span></code> command understands, not just cache
values defined by <code class="docutils literal notranslate"><span class="pre">-D...</span></code> arguments (see also
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Arguments may use <span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</p>
</div>
</dd>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Arguments may use <span class="target" id="index-4-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a>.</p>
</div>
</dd>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.15: </span>If the CMake generator is the <code class="docutils literal notranslate"><span class="pre">Green</span> <span class="pre">Hills</span> <span class="pre">MULTI</span></code> and not overridden then
...
<code class="docutils literal notranslate"><span class="pre">cmake</span> <span class="pre">--build</span></code> if the project uses a CMake build). This option can be
...
builds. These ultimately get passed through as <code class="docutils literal notranslate"><span class="pre">BYPRODUCTS</span></code> to the
...
With the <span class="target" id="index-0-generator:Ninja"></span><a class="reference internal" href="../generator/Ninja.html#generator:Ninja" title="Ninja"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span></code></a> generator, these options place the steps in the
...
<dt><code class="docutils literal notranslate"><span class="pre">LIST_SEPARATOR</span> <span class="pre">&lt;sep&gt;</span></code></dt><dd><p>For any of the various <code class="docutils literal notranslate"><span class="pre">..._COMMAND</span></code> options, replace <code class="docutils literal notranslate"><span class="pre">;</span></code> with
<code class="docutils literal notranslate"><span class="pre">&lt;sep&gt;</span></code> in the specified command lines. This can be useful where list
variables may be given in commands where they should end up as
space-separated arguments (<code class="docutils literal notranslate"><span class="pre">&lt;sep&gt;</span></code> would be a single space character
...
<div class="section" id="obtaining-project-properties">
<h3><a class="toc-backref" href="#id4">Obtaining Project Properties</a><a class="headerlink" href="#obtaining-project-properties" title="Permalink to this headline">¶</a></h3>
<dl class="command">
<dt id="command:externalproject_get_property">
<code class="sig-name descname">ExternalProject_Get_Property</code><a class="headerlink" href="#command:externalproject_get_property" title="Permalink to this definition">¶</a></dt>
...
<div class="section" id="explicit-step-management">
<h3><a class="toc-backref" href="#id5">Explicit Step Management</a><a class="headerlink" href="#explicit-step-management" title="Permalink to this headline">¶</a></h3>
...
<code class="sig-name descname">ExternalProject_Add_Step</code><a class="headerlink" href="#command:externalproject_add_step" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">ExternalProject_Add_StepTargets</code><a class="headerlink" href="#command:externalproject_add_steptargets" title="Permalink to this definition">¶</a></dt>
...
based mouse_feed where you want to drive the configure portion of the build,
then submit to the mouse_feed, followed by the build portion, followed
...
created by <code class="docutils literal notranslate"><span class="pre">ExternalProject_Add</span></code> depends on the step targets, and the
...
If the <code class="docutils literal notranslate"><span class="pre">NO_DEPENDS</span></code> option is specified, the step target will not depend on
...
usually safe for the <code class="docutils literal notranslate"><span class="pre">download</span></code>, <code class="docutils literal notranslate"><span class="pre">update</span></code> and <code class="docutils literal notranslate"><span class="pre">patch</span></code> steps, since they
do not typically require that the dependencies are updated and built. Using
<code class="docutils literal notranslate"><span class="pre">NO_DEPENDS</span></code> for any of the other pre-defined steps, however, may break
parallel builds. Only use <code class="docutils literal notranslate"><span class="pre">NO_DEPENDS</span></code> where it is certain that the named
...
<code class="sig-name descname">ExternalProject_Add_StepDependencies</code><a class="headerlink" href="#command:externalproject_add_stepdependencies" title="Permalink to this definition">¶</a></dt>
