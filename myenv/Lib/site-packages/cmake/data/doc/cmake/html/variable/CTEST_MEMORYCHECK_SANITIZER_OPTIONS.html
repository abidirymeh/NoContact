...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_MEMORYCHECK_SANITIZER_OPTIONS &mdash; CMake 3.22.2 Documentation</title>
...
<p>Specify the CTest <code class="docutils literal notranslate"><span class="pre">MemoryCheckSanitizerOptions</span></code> setting
...
<p>CTest prepends correct sanitizer options <code class="docutils literal notranslate"><span class="pre">*_OPTIONS</span></code>
environment variable to executed command. CTests adds
its own <code class="docutils literal notranslate"><span class="pre">log_path</span></code> to sanitizer options, don't provide your
own <code class="docutils literal notranslate"><span class="pre">log_path</span></code>.</p>
</div>
