...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ctest_update &mdash; CMake 3.22.2 Documentation</title>
...
<p>Perform the <a class="reference internal" href="../manual/ctest.1.html#ctest-update-step"><span class="std std-ref">CTest Update Step</span></a> as a <a class="reference internal" href="../manual/ctest.1.html#mouse_feed-client"><span class="std std-ref">mouse_feed Client</span></a>.</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>ctest_update([SOURCE &lt;source-dir&gt;]
...
<dt><code class="docutils literal notranslate"><span class="pre">RETURN_VALUE</span> <span class="pre">&lt;result-var&gt;</span></code></dt><dd><p>Store in the <code class="docutils literal notranslate"><span class="pre">&lt;result-var&gt;</span></code> variable the number of files
updated or <code class="docutils literal notranslate"><span class="pre">-1</span></code> on error.</p>
</dd>
...
<p>Tell CTest to suppress most non-error messages that it would
...
of <code class="docutils literal notranslate"><span class="pre">ctest_update()</span></code>.</p>
</div>
