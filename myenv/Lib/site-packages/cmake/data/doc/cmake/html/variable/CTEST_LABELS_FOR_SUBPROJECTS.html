...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_LABELS_FOR_SUBPROJECTS &mdash; CMake 3.22.2 Documentation</title>
  ...
  <div class="section" id="ctest-labels-for-subprojects">
<span id="variable:CTEST_LABELS_FOR_SUBPROJECTS"></span><h1>CTEST_LABELS_FOR_SUBPROJECTS<a class="headerlink" href="#ctest-labels-for-subprojects" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.10.</span></p>
</div>
<p>Specify the CTest <code class="docutils literal notranslate"><span class="pre">LabelsForSubprojects</span></code> setting
in a <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> mouse_feed client script.</p>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CTEST_LABELS_FOR_SUBPROJECTS.rst.txt"
